...
DOTFILES=".bash_functions .bash_profile .bashrc .editorconfig .gitconfig-base .gitignore .gitignore_global .ideavimrc .inputrc .itermocil .mrxvtrc .oh-my-zsh-custom .profile .screenrc .shell_aliases .shell_functions .shellrc .studioforkdb .tmux.conf .toprc .vimrc .vscode .xemacs .zlogin .zsh_functions .zshrc"
