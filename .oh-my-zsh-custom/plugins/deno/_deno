...
'(--no-check)--check=[Enable type-checking. This subcommand does not type-check by default; pass --check=all to also type-check remote modules. Alternatively, use the '\''deno check'\'' subcommand.]::CHECK_TYPE:_default' \
...
'(--watch)*--watch-hmr=[Watch for file changes and hot-replace modules. The process restarts if hot replacement fails.   Local files from entry point module graph are watched by default.   Additional paths might be watched by passing them as arguments to this flag.]::FILES:_files' \
...
'(--no-use-env-proxy)--use-env-proxy[Use HTTP_PROXY, HTTPS_PROXY, and NO_PROXY for node\:http/node\:https]' \
...
'--unstable-node-globals[Deprecated. Node.js \`setTimeout\` and \`setInterval\` globals are now always enabled, so this flag has no effect.]' \
...
'--unstable-raw-imports[Enable unstable '\''bytes'\'' imports.]' \
...
'-q[Suppress diagnostic output]' \
'--quiet[Suppress diagnostic output]' \
'-D[Add the package as a dev dependency (under \`devDependencies\`). Note\: this only applies when adding to a \`package.json\` file.]' \
'--dev[Add the package as a dev dependency (under \`devDependencies\`). Note\: this only applies when adding to a \`package.json\` file.]' \
'(-D --dev)-O[Add the package as an optional dependency (under \`optionalDependencies\`). Note\: this only applies when adding to a \`package.json\` file.]' \
'(-D --dev)--save-optional[Add the package as an optional dependency (under \`optionalDependencies\`). Note\: this only applies when adding to a \`package.json\` file.]' \
'(-D --dev -O --save-optional)--no-save[Install the package(s) without adding them to the configuration file.]' \
'(--lock)--no-lock[Disable auto discovery of the lock file]' \
'--lockfile-only[Install only updating the lockfile]' \
'(--jsr)--npm[assume unprefixed package names are npm packages (default)]' \
...
'--lock=[Check the specified lock file. (If value is not provided, defaults to "./deno.lock")]::FILE:_files' \
'--frozen=[Error out if lockfile is out of date]::BOOLEAN:(true false)' \
'(-g --global)--minimum-dependency-age=[(Unstable) The age in minutes, ISO-8601 duration or RFC3339 absolute timestamp (e.g. '\''120'\'' for two hours, '\''P2D'\'' for two days, '\''2025-09-16'\'' for cutoff date, '\''2025-09-16T12\:00\:00+00\:00'\'' for cutoff time, '\''0'\'' to disable)]: :_default' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
'--unstable-bare-node-builtins[Enable unstable bare node builtins feature]' \
'--unstable-broadcast-channel[Enable unstable \`BroadcastChannel\` API]' \
'--unstable-bundle[Enable unstable bundle runtime API]' \
...
'(-g --global)--package-json[Force using package.json for dependency management instead of deno.json]' \
...
'*--preload=[A list of files that will be executed before the main module]:FILE:_files' \
'*--require=[A list of CommonJS modules that will be executed before the main module]:FILE:_files' \
'(--no-check)--check=[Set type-checking behavior. This subcommand type-checks local modules by default, so passing --check is redundant; pass --check=all to also type-check remote modules. Alternatively, use the '\''deno check'\'' subcommand.]::CHECK_TYPE:_default' \
...
'--target=[Target OS architecture]: :(x86_64-unknown-linux-gnu aarch64-unknown-linux-gnu x86_64-pc-windows-msvc aarch64-pc-windows-msvc x86_64-apple-darwin aarch64-apple-darwin)' \
'--engine=[JS engine the compiled binary runs on (quickjs is smaller and experimental, and does not receive the same security updates as v8)]: :(v8 quickjs)' \
'--icon=[Set the icon of the executable on Windows (.ico)]: :_default' \
'--app-name=[Stable identity for the compiled app.   Determines where origin-bound storage such as the default \`Deno.openKv()\`,   \`localStorage\` and \`caches\` is persisted (under the platform'\''s app data directory).   Defaults to the output file name. Set this to keep storage stable across renames.]: :_default' \
'*--watch-exclude=[Exclude provided files/patterns from watch mode]::FILES:_files' \
'--ext=[Set content type of the supplied file]: :(ts tsx js jsx mts mjs cts cjs)' \
'*--env-file=[Load environment variables from local file   Only the first environment variable with a given key is used.   Existing process environment variables are not overwritten, so if variables with the same names already exist in the environment, their values will be preserved.   Where multiple declarations for the same environment variable exist in your .env file, the first one encountered is applied. This is determined by the order of the files you pass as arguments.]::FILE:_files' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
...
'--bundle[Experimental. Bundle the entrypoint with esbuild before embedding, instead of shipping the whole node_modules tree.   Produces a smaller binary with faster startup, at the cost of dropping dynamic require/import patterns that can'\''t be statically traced.]' \
'--minify[Experimental. Minify the bundled output. Only meaningful with --bundle.   Reduces both the embedded bundle size and runtime memory use, at the cost of less readable stack traces.]' \
'--exclude-unused-npm[Embed only the npm packages reachable from the module graph (managed npm; no node_modules directory).   Without this flag the full managed npm snapshot from the lockfile / package.json is embedded.   Reduces binary size when the lockfile contains packages the entrypoint does not import.   Skips packages that are only reached through non-statically-analyzable dynamic imports;   pass those with --include npm\:<pkg> if needed.]' \
'--watch[Watch for file changes and restart process automatically.   Only local files from entry point module graph are watched.]' \
'--no-clear-screen[Do not clear terminal screen when under watch mode]' \
'*::script_arg -- Script arg:_files' \
&& ret=0
...
'*--require=[A list of CommonJS modules that will be executed before the main module]:FILE:_files' \
'(--no-check)--check=[Set type-checking behavior. This subcommand type-checks local modules by default, so passing --check is redundant; pass --check=all to also type-check remote modules. Alternatively, use the '\''deno check'\'' subcommand.]::CHECK_TYPE:_default' \
'--inspect-renderer=[Override the CEF renderer debugger listen address; defaults to an auto-allocated port]::HOST_PORT:_default' \
'*--include=[Includes an additional module or file/directory in the compiled executable.   Use this flag if a dynamically imported module or a web worker main module   fails to load in the executable or to embed a file or directory in the executable.   This flag can be passed multiple times, to include multiple additional modules.]: :_files' \
'*--exclude=[Excludes a file/directory in the compiled executable.   Use this flag to exclude a specific file or directory within the included files.]: :_files' \
'-o+[Output path (e.g. MyApp.app, MyApp.dmg, MyApp.AppImage, MyApp.deb, MyApp.rpm, MyApp.msi)]: :_files' \
'--output=[Output path (e.g. MyApp.app, MyApp.dmg, MyApp.AppImage, MyApp.deb, MyApp.rpm, MyApp.msi)]: :_files' \
'--target=[Target OS architecture]: :(x86_64-unknown-linux-gnu aarch64-unknown-linux-gnu x86_64-pc-windows-msvc aarch64-pc-windows-msvc x86_64-apple-darwin aarch64-apple-darwin)' \
'--icon=[Set the application icon (.ico on Windows, .icns or .png on macOS)]: :_default' \
'--backend=[Backend to use for the desktop app]: :(webview cef raw)' \
'--engine=[JS engine the desktop binary runs on (quickjs is smaller and experimental, and does not receive the same security updates as v8)]: :(v8 quickjs)' \
'--compress=[Make the packaged app self-extracting\: the payload is compressed inside the app and unpacked on first launch. Off by default. Defaults to xz (decompressed by the system \`tar\` everywhere); zstd is smaller/faster but needs the \`zstd\` tool at runtime.]:: :(xz lzma zstd)' \
'--ext=[Set content type of the supplied file]: :(ts tsx js jsx mts mjs cts cjs)' \
'*--env-file=[Load environment variables from local file   Only the first environment variable with a given key is used.   Existing process environment variables are not overwritten, so if variables with the same names already exist in the environment, their values will be preserved.   Where multiple declarations for the same environment variable exist in your .env file, the first one encountered is applied. This is determined by the order of the files you pass as arguments.]::FILE:_files' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
'--unstable-bare-node-builtins[Enable unstable bare node builtins feature]' \
...
'--threshold=[Fail if coverage is below this percentage (0-100), applied to line, branch, and function coverage.   Per-metric thresholds can be set in deno.json under "coverage"\: { "thresholds"\: { ... } }. The flag takes precedence.]:PERCENT:_default' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
'--unstable-bare-node-builtins[Enable unstable bare node builtins feature]' \
'--unstable-broadcast-channel[Enable unstable \`BroadcastChannel\` API]' \
'--unstable-bundle[Enable unstable bundle runtime API]' \
...
'-c+[Configure different aspects of deno including TypeScript, linting, and code formatting.   Typically the configuration file will be called \`deno.json\` or \`deno.jsonc\` and   automatically detected; in that case this flag is not necessary.   Docs\: https\://docs.deno.com/go/config]:FILE:_files' \
'--config=[Configure different aspects of deno including TypeScript, linting, and code formatting.   Typically the configuration file will be called \`deno.json\` or \`deno.jsonc\` and   automatically detected; in that case this flag is not necessary.   Docs\: https\://docs.deno.com/go/config]:FILE:_files' \
'--ext=[Set content type of the supplied file]: :(ts tsx js jsx mts mjs cts cjs md json jsonc css scss less html xml svg svelte vue astro yml yaml ipynb sql vto njk)' \
...
'--unstable-css[Enable formatting CSS, SCSS and Less files]' \
...
'-L+[Set log level]: :(trace debug info)' \
'--log-level=[Set log level]: :(trace debug info)' \
'--depth=[Maximum depth of the dependency tree to display (0 = direct dependencies only)]: :_default' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
'--unstable-bare-node-builtins[Enable unstable bare node builtins feature]' \
'--unstable-broadcast-channel[Enable unstable \`BroadcastChannel\` API]' \
'--unstable-bundle[Enable unstable bundle runtime API]' \
...
'-q[Suppress diagnostic output]' \
'--quiet[Suppress diagnostic output]' \
'(--dev)--prod[Only list production dependencies]' \
'--dev[Only list development dependencies]' \
'-r[Include all workspace members]' \
'--recursive[Include all workspace members]' \
'*::filters -- Filters selecting which packages to list. Can include wildcards (*) to match multiple packages, and a leading '\''!'\'' to exclude.:_default' \
&& ret=0
;;
(install)
_arguments "${_arguments_options[@]}" : \
...
'--root=[Installation root]: :_files -/' \
'*--env-file=[Load environment variables from local file   Only the first environment variable with a given key is used.   Existing process environment variables are not overwritten, so if variables with the same names already exist in the environment, their values will be preserved.   Where multiple declarations for the same environment variable exist in your .env file, the first one encountered is applied. This is determined by the order of the files you pass as arguments.]::FILE:_files' \
'(-g --global)--os=[Target OS for npm package installation (e.g., linux, darwin, win32)]: :(aix android darwin freebsd linux openbsd sunos win32)' \
'(-g --global)--arch=[Target architecture for npm package installation (e.g., x64, arm64)]: :(arm arm64 ia32 mips mipsel ppc ppc64 s390 s390x x64)' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
'--unstable-bare-node-builtins[Enable unstable bare node builtins feature]' \
'--unstable-broadcast-channel[Enable unstable \`BroadcastChannel\` API]' \
'--unstable-bundle[Enable unstable bundle runtime API]' \
...
'(-e --entrypoint -g --global)-D[Add the package as a dev dependency (under \`devDependencies\`). Note\: this only applies when adding to a \`package.json\` file.]' \
'(-e --entrypoint -g --global)--dev[Add the package as a dev dependency (under \`devDependencies\`). Note\: this only applies when adding to a \`package.json\` file.]' \
'(-D --dev -e --entrypoint -g --global)-O[Add the package as an optional dependency (under \`optionalDependencies\`). Note\: this only applies when adding to a \`package.json\` file.]' \
'(-D --dev -e --entrypoint -g --global)--save-optional[Add the package as an optional dependency (under \`optionalDependencies\`). Note\: this only applies when adding to a \`package.json\` file.]' \
'(-D --dev -O --save-optional -e --entrypoint -g --global)--no-save[Install the package(s) without adding them to the configuration file.]' \
'(--jsr -e --entrypoint -g --global)--npm[assume unprefixed package names are npm packages (default)]' \
...
'(-e --entrypoint -g --global)--unscoped[Use the package name without its scope as the alias (ex. \`jsr\:@david/jsonc-morph\` is added as \`jsonc-morph\`). Packages given an explicit alias are unaffected.]' \
'(-g --global)--lockfile-only[Install only updating the lockfile]' \
'(-e --entrypoint -g --global)--package-json[Force using package.json for dependency management instead of deno.json]' \
'(-g --global -D --dev)--prod[Only install production dependencies (excludes devDependencies)]' \
'--skip-types[Exclude @types/* packages from installation. Be careful, as it uses a name-based heuristic and may skip packages that ship runtime code.]' \
'*::cmd:_files' \
&& ret=0
;;
(i)
...
'-q[Suppress diagnostic output]' \
'--quiet[Suppress diagnostic output]' \
'-g[Remove globally installed packages or modules]' \
...
'(--lock)--no-lock[Disable auto discovery of the lock file]' \
'--lockfile-only[Install only updating the lockfile]' \
'*::paths -- Paths to local package directories to link:_default' \
&& ret=0
;;
(unlink)
_arguments "${_arguments_options[@]}" : \
...
'(--lock)--no-lock[Disable auto discovery of the lock file]' \
'--lockfile-only[Install only updating the lockfile]' \
'*::names_or_paths -- Linked package names or paths to remove:_default' \
&& ret=0
;;
(lsp)
_arguments "${_arguments_options[@]}" : \
...
'-L+[Set log level]: :(trace debug info)' \
'--log-level=[Set log level]: :(trace debug info)' \
'-o+[Output file path (defaults to <name>-<version>.tgz)]:FILE:_default' \
'--output=[Output file path (defaults to <name>-<version>.tgz)]:FILE:_default' \
'-c+[Configure different aspects of deno including TypeScript, linting, and code formatting.   Typically the configuration file will be called \`deno.json\` or \`deno.jsonc\` and   automatically detected; in that case this flag is not necessary.   Docs\: https\://docs.deno.com/go/config]:FILE:_files' \
'--config=[Configure different aspects of deno including TypeScript, linting, and code formatting.   Typically the configuration file will be called \`deno.json\` or \`deno.jsonc\` and   automatically detected; in that case this flag is not necessary.   Docs\: https\://docs.deno.com/go/config]:FILE:_files' \
'--set-version=[Override the version in the tarball]:VERSION:_default' \
'*--ignore=[Ignore files matching these patterns]: :_files' \
'*--env-file=[Load environment variables from local file   Only the first environment variable with a given key is used.   Existing process environment variables are not overwritten, so if variables with the same names already exist in the environment, their values will be preserved.   Where multiple declarations for the same environment variable exist in your .env file, the first one encountered is applied. This is determined by the order of the files you pass as arguments.]::FILE:_files' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
'--unstable-bare-node-builtins[Enable unstable bare node builtins feature]' \
'--unstable-broadcast-channel[Enable unstable \`BroadcastChannel\` API]' \
...
'*::files -- List of file patterns to include:_default' \
&& ret=0
;;
(repl)
_arguments "${_arguments_options[@]}" : \
...
'-j+[Maximum number of tasks to run concurrently. Overrides the DENO_JOBS environment variable; defaults to the number of available CPUs. Use 1 to force sequential execution. Only affects runs where multiple tasks can run concurrently (workspace runs, or a task with parallelizable dependencies)]:NUMBER:_default' \
'--jobs=[Maximum number of tasks to run concurrently. Overrides the DENO_JOBS environment variable; defaults to the number of available CPUs. Use 1 to force sequential execution. Only affects runs where multiple tasks can run concurrently (workspace runs, or a task with parallelizable dependencies)]:NUMBER:_default' \
'--concurrency=[Maximum number of tasks to run concurrently. Overrides the DENO_JOBS environment variable; defaults to the number of available CPUs. Use 1 to force sequential execution. Only affects runs where multiple tasks can run concurrently (workspace runs, or a task with parallelizable dependencies)]:NUMBER:_default' \
'*--env-file=[Load environment variables from local file   Only the first environment variable with a given key is used.   Existing process environment variables are not overwritten, so if variables with the same names already exist in the environment, their values will be preserved.   Where multiple declarations for the same environment variable exist in your .env file, the first one encountered is applied. This is determined by the order of the files you pass as arguments.]::FILE:_files' \
'--node-modules-dir=[Selects the node_modules directory mode for npm packages (not a path). One of\: auto (create a local node_modules directory and install npm packages into it), manual (use the existing local node_modules directory, do not modify it), none (do not use a local node_modules directory; resolve npm packages from the global cache). Defaults to auto when the flag is passed without a value.]::MODE:_default' \
'--node-modules-linker=[Sets the linker mode for npm packages (isolated or hoisted)]:MODE:_default' \
'-t+[Execute tasks with a tunnel to Deno Deploy.      Create a secure connection between your local machine and Deno Deploy,     providing access to centralised environment variables, logging,     and serving from your local environment to the public internet]:: :(true false)' \
...
'(-r --recursive -f --filter)--members[Run the task in all workspace members, but not in the workspace root]' \
...
'--retry=[Re-run failing tests up to NUMBER times. A test passes if any attempt passes. Tests that set their own \`retry\` option take precedence]:NUMBER:_default' \
'--repeats=[Run each test NUMBER additional times. Every repetition must pass. Tests that set their own \`repeats\` option take precedence]:NUMBER:_default' \
'--shard=[Run only the test files for shard INDEX of COUNT, e.g. --shard=2/3.   The discovered test files are sorted and split into COUNT consecutive groups; INDEX is 1-based. Useful for splitting a run across machines.]:INDEX/COUNT:_default' \
...
'--coverage-threshold=[Fail if coverage is below this percentage (0-100). Requires --coverage]:PERCENT:_default' \
'(--watch)--changed=[Run only test modules affected by files changed in git.   With no value, uses uncommitted changes (staged, unstaged and untracked).   Pass a git ref to compare against, e.g. --changed=main or --changed=HEAD~1.]::REF:_default' \
'(--watch)*--related=[Run only test modules that depend on the given source files]: :_files' \
...
'-u[Update snapshots created with \`t.assertSnapshot()\` instead of failing when they do not match]' \
...
'--unsafely-ignore-certificate-errors=[DANGER\: Disables verification of TLS certificates]::HOSTNAMES:_default' \
'--minimum-dependency-age=[(Unstable) The age in minutes, ISO-8601 duration or RFC3339 absolute timestamp (e.g. '\''120'\'' for two hours, '\''P2D'\'' for two days, '\''2025-09-16'\'' for cutoff date, '\''2025-09-16T12\:00\:00+00\:00'\'' for cutoff time, '\''0'\'' to disable)]: :_default' \
'(--outdir)-o+[Output file path (for single file transpilation)]: :_files' \
'(--outdir)--output=[Output file path (for single file transpilation)]: :_files' \
'--outdir=[Output directory for transpiled files]: :_files -/' \
'--source-map=[Source map mode\: none, inline, or separate]: :(none inline separate)' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
'--unstable-bare-node-builtins[Enable unstable bare node builtins feature]' \
'--unstable-broadcast-channel[Enable unstable \`BroadcastChannel\` API]' \
'--unstable-bundle[Enable unstable bundle runtime API]' \
...
'::version-or-hash-or-channel -- Version (v1.46.0), channel (alpha, beta, rc, canary), commit hash (9bc2dd29ad6ba334fd57a20114e367d3c04763d4), or pr 12345 to install from a PR:_default' \
&& ret=0
;;
(bump-version)
_arguments "${_arguments_options[@]}" : \
...
'-L+[Set log level]: :(trace debug info)' \
'--log-level=[Set log level]: :(trace debug info)' \
'--start=[\[conventional-commits mode\] Git ref to start from. Default\: latest tag (git describe --tags --abbrev=0)]:REF:_default' \
'--base=[\[conventional-commits mode\] Git ref to compare against. Default\: current branch]:REF:_default' \
'--import-map=[Path to the import map to rewrite jsr\: version constraints in. Defaults to the root deno.json (or its importMap target)]:PATH:_default' \
'--release-notes=[\[conventional-commits mode\] Path to the release notes file to prepend. Default\: Releases.md]:PATH:_default' \
'(-w --workspace)-c+[Explicit path to the manifest file to bump.   May point to a \`deno.json\`/\`deno.jsonc\` or a \`package.json\`. When   set, single-file mode is forced (workspace auto-detection is bypassed).   Useful when both \`deno.json\` and \`package.json\` exist in the same   directory.]:FILE:_files' \
'(-w --workspace)--config=[Explicit path to the manifest file to bump.   May point to a \`deno.json\`/\`deno.jsonc\` or a \`package.json\`. When   set, single-file mode is forced (workspace auto-detection is bypassed).   Useful when both \`deno.json\` and \`package.json\` exist in the same   directory.]:FILE:_files' \
'--unstable[The \`--unstable\` flag has been deprecated. Use granular \`--unstable-*\` flags instead   To view the list of individual unstable feature flags, run this command again with --help=unstable]' \
'--unstable-bare-node-builtins[Enable unstable bare node builtins feature]' \
'--unstable-broadcast-channel[Enable unstable \`BroadcastChannel\` API]' \
'--unstable-bundle[Enable unstable bundle runtime API]' \
...
'-q[Suppress diagnostic output]' \
'--quiet[Suppress diagnostic output]' \
'-w[Bump every package in the workspace (auto-detected at the workspace root)]' \
'--workspace[Bump every package in the workspace (auto-detected at the workspace root)]' \
'(-w --workspace)--no-workspace[Disable workspace mode and only bump the deno.json/package.json in the current directory]' \
'--dry-run[Print the planned changes without writing any files]' \
'::increment -- Version increment type:(major minor patch premajor preminor prepatch prerelease)' \
&& ret=0
;;
(vendor)
_arguments "${_arguments_options[@]}" : \
...
'--quiet[Suppress diagnostic output]' \
'(--lock)--no-lock[Disable auto discovery of the lock file]' \
':package -- The package name (and optional version) to explain:_default' \
&& ret=0
;;
(x)
_arguments "${_arguments_options[@]}" : \
...
'*--preload=[A list of files that will be executed before the main module]:FILE:_files' \
'*--require=[A list of CommonJS modules that will be executed before the main module]:FILE:_files' \
'(--install-alias)*--ignore-scripts=[Do not run npm lifecycle scripts for the given packages]::PACKAGE:_default' \
'(--install-alias)-p+[Package to install (use when the binary name differs from the package name)]: :_default' \
'(--install-alias)--package=[Package to install (use when the binary name differs from the package name)]: :_default' \
'(--no-check)--check=[Enable type-checking. This subcommand does not type-check by default; pass --check=all to also type-check remote modules. Alternatively, use the '\''deno check'\'' subcommand.]::CHECK_TYPE:_default' \
'*--env-file=[Load environment variables from local file   Only the first environment variable with a given key is used.   Existing process environment variables are not overwritten, so if variables with the same names already exist in the environment, their values will be preserved.   Where multiple declarations for the same environment variable exist in your .env file, the first one encountered is applied. This is determined by the order of the files you pass as arguments.]::FILE:_files' \
...
'add:Add dependencies to your configuration file.   deno add express  Unprefixed packages default to npm. Use jsr\: prefix for jsr packages\:   deno add jsr\:@std/path  Or multiple dependencies at once\:   deno add express jsr\:@std/path' \
...
'remove:Remove dependencies from the configuration file.   deno remove @std/path  You can remove multiple dependencies at once\:   deno remove @std/path @std/assert  With the --global flag, this is an alias for deno uninstall --global and removes a globally installed executable script\:   deno remove --global file_server ' \
...
'desktop:Build and run desktop applications.    deno desktop main.tsx   deno desktop --hmr main.tsx   deno desktop --output MyApp.app main.tsx   deno desktop  Compiles the given script into a desktop application using a backend for the UI layer. The entrypoint can be a file, or omitted (or .) to auto-detect a supported framework (Next.js, Astro, etc.) in the current directory.  Read more\: https\://docs.deno.com/go/desktop ' \
...
'pack:Create an npm-compatible tarball from a Deno project' \
...
'why:Show why a package is installed, displaying the dependency chain from your project'\''s direct dependencies to the specified package.   deno why express  Show why a specific version is installed   deno why express@4.18.2' \
...
(( $+functions[_deno__bump-version_commands] )) ||
_deno__bump-version_commands() {
    local commands; commands=()
    _describe -t commands 'deno bump-version commands' commands "$@"
}
...
(( $+functions[_deno__ci_commands] )) ||
_deno__ci_commands() {
    local commands; commands=()
    _describe -t commands 'deno ci commands' commands "$@"
}
...
(( $+functions[_deno__desktop_commands] )) ||
_deno__desktop_commands() {
    local commands; commands=()
    _describe -t commands 'deno desktop commands' commands "$@"
}
...
(( $+functions[_deno__help__bump-version_commands] )) ||
_deno__help__bump-version_commands() {
    local commands; commands=()
    _describe -t commands 'deno help bump-version commands' commands "$@"
}
...
(( $+functions[_deno__help__ci_commands] )) ||
_deno__help__ci_commands() {
    local commands; commands=()
    _describe -t commands 'deno help ci commands' commands "$@"
}
...
(( $+functions[_deno__help__desktop_commands] )) ||
_deno__help__desktop_commands() {
    local commands; commands=()
    _describe -t commands 'deno help desktop commands' commands "$@"
}
...
(( $+functions[_deno__help__link_commands] )) ||
_deno__help__link_commands() {
    local commands; commands=()
    _describe -t commands 'deno help link commands' commands "$@"
}
...
(( $+functions[_deno__help__list_commands] )) ||
_deno__help__list_commands() {
    local commands; commands=()
    _describe -t commands 'deno help list commands' commands "$@"
}
...
(( $+functions[_deno__help__pack_commands] )) ||
_deno__help__pack_commands() {
    local commands; commands=()
    _describe -t commands 'deno help pack commands' commands "$@"
}
...
(( $+functions[_deno__help__transpile_commands] )) ||
_deno__help__transpile_commands() {
    local commands; commands=()
    _describe -t commands 'deno help transpile commands' commands "$@"
}
...
(( $+functions[_deno__help__unlink_commands] )) ||
_deno__help__unlink_commands() {
    local commands; commands=()
    _describe -t commands 'deno help unlink commands' commands "$@"
}
...
(( $+functions[_deno__help__watch_commands] )) ||
_deno__help__watch_commands() {
    local commands; commands=()
    _describe -t commands 'deno help watch commands' commands "$@"
}
(( $+functions[_deno__help__why_commands] )) ||
_deno__help__why_commands() {
    local commands; commands=()
    _describe -t commands 'deno help why commands' commands "$@"
}
...
(( $+functions[_deno__link_commands] )) ||
_deno__link_commands() {
    local commands; commands=()
    _describe -t commands 'deno link commands' commands "$@"
}
...
(( $+functions[_deno__list_commands] )) ||
_deno__list_commands() {
    local commands; commands=()
    _describe -t commands 'deno list commands' commands "$@"
}
...
(( $+functions[_deno__pack_commands] )) ||
_deno__pack_commands() {
    local commands; commands=()
    _describe -t commands 'deno pack commands' commands "$@"
}
...
(( $+functions[_deno__transpile_commands] )) ||
_deno__transpile_commands() {
    local commands; commands=()
    _describe -t commands 'deno transpile commands' commands "$@"
}
...
(( $+functions[_deno__unlink_commands] )) ||
_deno__unlink_commands() {
    local commands; commands=()
    _describe -t commands 'deno unlink commands' commands "$@"
}
...
(( $+functions[_deno__watch_commands] )) ||
_deno__watch_commands() {
    local commands; commands=()
    _describe -t commands 'deno watch commands' commands "$@"
}
(( $+functions[_deno__why_commands] )) ||
_deno__why_commands() {
    local commands; commands=()
    _describe -t commands 'deno why commands' commands "$@"
}
